...
var menu_CascaderMenu = (_temp = _class = function (_React$Component) {
    _inherits(CascaderMenu, _React$Component);
    ...
    function CascaderMenu(props) {
        ...
        _this.handleMenuItemClick = function (option, menuIndex) {
            return function (e) {
                e.stopPropagation();
                ...
                var _this$state = _this.state,
                    activeValues = _this$state.activeValues,
                ...
                if (!children) {
                    _this.props.emitter.emit('selected', activeValues, labels);
                }
            };
        };

        _this.getOption = function (option, menuIndex) {
            ...
            return external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.createElement(
                ...
                { className: classnames_default()('cascader-menu-option', {
                    ...
                    }), key: option.value, value: option.value, onClick: _this.handleMenuItemClick(option, menuIndex) },
                option.label
            );
        };
        ...
        _this.getActiveOptions = function () {
            ...
            var activeValues = _this.state.activeValues;
        ...
        _this.getShowOptions = function () {
            ...
            var result = _this.getActiveOptions().map(function (activeOption) {
        ...
        _this.getActiveLabels = function (codes) {
            var provinces = data_default.a['86'];
            var citys = data_default.a[codes[0]];
            var l = codes.length;
            ...
            if (l === 2) {
                ...
                var areas = data_default.a[codes[1]];
        ...
        _this.resetActiveVal = function (labels) {
            _this.setState({
                activeValues: _this.props.values,
                labels: _this.getActiveLabels(_this.props.values)
            });
        };

        _this.setDefValues = function (codes, labels) {
            _this.setState({
                activeValues: codes,
                labels: labels
            });
        ...
        _this.scrollToSelectedOption = function () {
            var optionsLength = _this.getShowOptions().length;
            for (var i = 0; i < optionsLength; i++) {
                var itemComponent = _this.menuItems[i];
                if (itemComponent) {
                    ...
                    target && Object(utils["d" /* scrollIntoView */])(ul, target);
                }
            }
        };

        _this.saveMenuRef = function (index) {
    ...
    CascaderMenu.prototype.render = function render() {
        ...
        return external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.createElement(
            ...
            this.getShowOptions().map(function (options, index) {
                return external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.createElement(
                    'ul',
                    { className: 'cascader-menu-list', key: index, ref: _this2.saveMenuRef(index) },
                    options.map(function (option) {
                        return _this2.getOption(option, index);
                    })
                );
            })
        );
    ...
    return CascaderMenu;
}(external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.Component), _class.displayName = 'CascaderMenu', _class.defaultProps = {
    data: [],
    values: []
}, _temp);
...
var cascader_Cascader = (cascader__temp = cascader__class = function (_React$Component) {
    ...
    function Cascader(props) {
        ...
        _this.handleTriggerClick = function (e) {
            ...
            var tmp = _this.state.shown;
            if (!tmp) {
                _this.props.emitter.emit('shown');
            }
            ...
            _this.setState({
                ...
                if (!_this.state.shown) {
                    _this.props.emitter.emit('doc-click');
                }
            });
        };
        ...
        _this.handleSelectedChange = function (codes, labels) {
            _this.setState({
                shown: false,
                label: labels.join(_this.props.separator),
                values: codes
            });
        };
    ...
    Cascader.prototype.render = function render() {
        var _props = this.props,
            ...
            rest = _objectWithoutProperties(_props, ['placeholder', 'disabled', 'size', 'children', 'options']);
        ...
        return external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.createElement(
            ...
            external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.createElement(
                ...
                external___root___React___commonjs2___react___commonjs___react___amd___react___default.a.createElement(menu_CascaderMenu, _extends({ data: options, values: values }, rest))
            )
        );
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return area_cascader_AreaCascader; });
...
var area_cascader_AreaCascader = (area_cascader__temp = area_cascader__class = function (_React$Component) {
    ...
    function AreaCascader(props) {
        ...
        _this.handleSelectChange = function (codes, labels) {
            var _this$props = _this.props,
                onChange = _this$props.onChange,
                type = _this$props.type;


            Object(utils["a" /* assert */])(codes.length === labels.length, '地区数据可能出错了');
            if (_this.state.isSetDefault) {
                _this.emitter.emit('set-def-values', codes, labels);
            }
    ...
    AreaCascader.prototype.iterateAreas = function iterateAreas() {
        ...
        for (var i = 0, c = cities.length; i < c; i++) {
            ...
            for (var j = 0, l = city.children.length; j < l; j++) {
                ...
                var areas = this.iterate(data_default.a[city.children[j].value]);
                // fix: https://github.com/dwqs/vue-area-linkage/issues/7
                if (areas.length) {
                    item['children'] = areas;
                } else {
    ...
    AreaCascader.prototype.setDefVal = function setDefVal() {
        ...
        var citys = data_default.a[provinceCode];
    ...
    AreaCascader.prototype.componentDidMount = function componentDidMount() {
        var _props2 = this.props,
            level = _props2.level,
            defaultArea = _props2.defaultArea;
        ...
        if (Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length === level + 2) {
            this.beforeSetDefault();
        }

        if (Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length && defaultArea.length !== level + 2) {
            Object(utils["a" /* assert */])(false, '\u8BBE\u7F6E\u7684\u9ED8\u8BA4\u503C\u548C level \u503C\u4E0D\u5339\u914D');
        }
    ...
    AreaCascader.prototype.componentDidUpdate = function componentDidUpdate() {
        ...
        if (!isSetDefault && Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length === level + 2) {
            this.beforeSetDefault();
        }

        if (!isSetDefault && Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length && defaultArea.length !== level + 2) {
            Object(utils["a" /* assert */])(false, '\u8BBE\u7F6E\u7684\u9ED8\u8BA4\u503C\u548C level \u503C\u4E0D\u5339\u914D');
        }
    };
