...
var external___root___ReactDOM___commonjs2___react_dom___commonjs___react_dom___amd___react_dom__ = __webpack_require__(10);
...
var select_Select = (_temp = _class = function (_React$Component) {
    ...
    function Select(props) {
        ...
        _this.setPosition = function () {
            ...
            if (isUpdate) {
                _this.setState({
                    top: Object(utils["e" /* setPanelPosition */])(panelHeight, _this.areaRect)
                });
            } else {
                return Object(utils["e" /* setPanelPosition */])(panelHeight, _this.areaRect);
            }
        };

        _this.handleDocClick = function (e) {
            var target = e.target;
            if (!Object(utils["b" /* contains */])(_this.rootDOM, target) && _this.state.shown) {
                _this.setState({
                    shown: false
                });
            }
        ...
        _this.handleDocResize = function () {
            _this.areaRect = _this.rootDOM.getBoundingClientRect();
            _this.setPosition();
        };
        ...
        _this.scrollToSelectedOption = function () {
            ...
            target && Object(utils["d" /* scrollIntoView */])(_this.listWrap, target);
        };

        _this.setWrapRef = function (node) {
            _this.listWrap = node;
        };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return area_select_AreaSelect; });
...
var area_select_AreaSelect = (area_select__temp = area_select__class = function (_React$Component) {
    ...
    AreaSelect.prototype.setDefVal = function setDefVal() {
        ...
        if (this.state.isCode) {
            ...
            Object(utils["a" /* assert */])(province, '\u7701\u4EFD ' + defaults[0] + ' \u4E0D\u5B58\u5728');
    ...
    AreaSelect.prototype.provinceChange = function provinceChange(code, text) {
        ...
        var citys = data_default.a[code];
        if (!citys) {
            var _citys;

            Object(utils["a" /* assert */])(citys, '(\u57CE\u5E02)\u5730\u533A\u6570\u636E\u51FA\u73B0\u4E86\u9519\u8BEF');
            this.setState({
        ...
        if (defaults[1]) {
            if (isCode) {
                ...
                Object(utils["a" /* assert */])(curCityCode, '\u57CE\u5E02 ' + defaults[1] + ' \u4E0D\u5B58\u5728\u4E8E\u7701\u4EFD ' + defaults[0] + ' \u4E2D');
                curCity = citys[curCityCode];
            } else {
                curCity = lodash_find_default()(citys, function (item) {
                    return item === defaults[1];
                });
                Object(utils["a" /* assert */])(curCity, '\u57CE\u5E02 ' + defaults[1] + ' \u4E0D\u5B58\u5728\u4E8E\u7701\u4EFD ' + defaults[0] + ' \u4E2D');
                curCityCode = lodash_find_default()(Object.keys(citys), function (item) {
        ...
        if (level === 1) {
            ...
            var areas = data_default.a[curCityCode];

            if (!areas) {
                var _areas;

                Object(utils["a" /* assert */])(areas, '(\u5E02\u533A)\u5730\u533A\u6570\u636E\u51FA\u73B0\u4E86\u9519\u8BEF');
                this.setState({
            ...
            if (defaults[2]) {
                if (isCode) {
                    ...
                    Object(utils["a" /* assert */])(curAreaCode, '\u53BF\u533A ' + defaults[2] + ' \u4E0D\u5B58\u5728\u4E8E\u57CE\u5E02 ' + defaults[1] + ' \u4E2D');
                    curArea = areas[curAreaCode];
                } else {
                    curArea = lodash_find_default()(areas, function (item) {
                        return item === defaults[2];
                    });
                    Object(utils["a" /* assert */])(curArea, '\u53BF\u533A ' + defaults[2] + ' \u4E0D\u5B58\u5728\u4E8E\u57CE\u5E02 ' + defaults[1] + ' \u4E2D');
                    curAreaCode = lodash_find_default()(Object.keys(areas), function (item) {
    ...
    AreaSelect.prototype.render = function render() {
        ...
        if (!Object(utils["c" /* isArray */])(placeholders)) {
            placeholders = [];
        }
    ...
    AreaSelect.prototype.componentDidMount = function componentDidMount() {
        ...
        if (Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length === level + 1) {
            this.beforeSetDefault();
        }

        if (Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length && defaultArea.length !== level + 1) {
    ...
    AreaSelect.prototype.componentDidUpdate = function componentDidUpdate() {
        ...
        if (!isSetDefault && Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length === level + 1) {
            this.beforeSetDefault();
        }

        if (!isSetDefault && Object(utils["c" /* isArray */])(defaultArea) && defaultArea.length && defaultArea.length !== level + 1) {
            Object(utils["a" /* assert */])(false, '\u8BBE\u7F6E\u7684\u9ED8\u8BA4\u503C\u548C level \u503C\u4E0D\u5339\u914D');
        }
    };
