...
export default class Header extends Component {
    ...
    render () {
        return (
            <header>
                <a href="https://github.com/dwqs/vue-area-linkage" className="github-corner" aria-label="View source on Github">
                ...
                <p>
                    省、市、区、街道联动选择，UI 基于 
                    <a target="_blank" href="https://eleme.github.io/element-react">Element React</a>
                </p>
            </header>
        );
    }
